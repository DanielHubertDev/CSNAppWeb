let employeeRef = db.collection('users');
let deleteIDs = [];
	...
	data.docs.forEach(doc => {
		...
		let item =
			`<tr data-id="${doc.id}">
					...
					<td class="employee-name">${doc.id}</td>
					<td class="employee-email">${employee.name}</td>
					<td class="employee-address">${employee.email}</td>
					<td>
							<a href="#" id="${doc.id}" class="edit js-edit-employee"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
							</a>
					</td>
					<td>
							<a href="#" id="${doc.id}" class="edit js-edit-employee"><i class="material-icons" data-toggle="tooltip" title="Voir">&#xe8f4;</i>
							</a>
					</td>
					<td>
							<a href="#" id="${doc.id}" class="delete js-delete-employee"><i class="material-icons" data-toggle="tooltip" title="Etat">&#xE872;</i>
							</a>
					</td>
			</tr>`;
...
$(document).ready(function () {
	...
	$("#add-employee-form").submit(function (event) {
		...
		let employeeSexe = $('#employee-sexe').val();
		db.collection('users').add({
			...
			createdAt : firebase.firestore.FieldValue.serverTimestamp()
				...
				`<tr data-id="${docRef.id}">
						...
						<td class="employee-phone">${employeeSexe}</td>
						<td>
							<a href="#" id="${doc.id}" class="edit js-edit-employee"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
							</a>
						</td>
